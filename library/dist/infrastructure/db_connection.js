...
function getDBClient(url, port, login, password) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    var dbUrl = "mongodb://".concat(login, ":").concat(password, "@").concat(url, ":").concat(port, "/");
                    mongoose_1.default.connect(dbUrl).catch(function (err) {
