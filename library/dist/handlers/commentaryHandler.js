...
function default_1(socket) {
    var _this = this;
    var commentMessage = function (data) { return __awaiter(_this, void 0, void 0, function () {
        var bookId, comment;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    bookId = socket.handshake.query.bookId;
                    data.bookId = typeof bookId === 'string' ? bookId : '';
                    data.date = Date.now();
                    return [4 /*yield*/, commentsRepository.add(data).catch(errorHandler_1.errorHandler)];
                case 1:
                    comment = _a.sent();
